...
Product name is **VaultForgian**. The Obsidian plugin id and installed folder remain `obsidian-codex-study` for beta compatibility, so existing manual installs and update paths continue to work.
...
3. Paste `https://github.com/KK1182112KK/vaultforgian`.
4. Enable **VaultForgian** in Community Plugins.
...
3. Restart Obsidian and enable **VaultForgian**.
...
2. `Open VaultForgian workspace` opens the workspace view.
