  ...
  const lines =
    locale === "ja"
      ? [
          ...
          `- ${copy.workspace.addPanel} は floating popup を開き、title と prompt を保存してから panel を作成します。最大 6 個までです。`,
      ...
      : [
          ...
          `- ${copy.workspace.addPanel} opens a floating popup. The panel is created only after you save a title and prompt. The hub supports up to 6 panels.`,
